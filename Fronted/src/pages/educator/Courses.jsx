      ...
      <div className=" w-[100%] min-h-screen p-4 sm:p-6 bg-gray-100">
        ...
        <div className=" md:hidden space-y-4">
          ...
          >
            ...
            <span className={ `w-fit px-3 py-1  text-xs rounded-full ${course?.isPublished ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"} `}>{course?.isPublished ? "Published" :"   Draft"}
