...
const Dashboard = () => {
  ...
  return (
    <div className='
     ...
     < FaLongArrowAltLeft className=' w-[22px] absolute top-[10%] left-[10%] h-[22px] cursor-pointer' onClick={()=>navigate("/")}/>
  ...
  <div className="w-28 h-28 rounded-full flex items-center justify-center bg-gray-300 border-4 border-black shadow-md text-3xl font-bold text-black">
